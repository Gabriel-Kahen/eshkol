...
int main(int argc, char** argv) {
    ...
    if (!input) {
        std::fprintf(stderr, "FAIL: could not open conjugate fixture\n");
        return 1;
    }
    ...
    const eshkol_tagged_value_t fixture =
        eshkol_eval_string(source.str().c_str(), nullptr);
    if (fixture.type != ESHKOL_VALUE_INT64 || fixture.data.int_val != 1) {
        std::fprintf(stderr, "FAIL: f32 conjugate JIT fixture failed\n");
        return 1;
    }
    return 0;
}
