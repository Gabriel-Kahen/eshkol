...
`surface_total` equals **1,110**, confirmed by combined core and quantum
execution traces at `79074607` on 2026-09-25. The earlier surface of 1,108
constructs was confirmed by a fresh run of `scripts/run_language_coverage.sh`
at `afbaaf5b` on 2026-08-26. The current count is the figure this doc,
README.md, and `.icc/architecture-model.yaml` now use
